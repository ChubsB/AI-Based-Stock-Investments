  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center sm:py-12">
      <div className="bg-secondayBackground shadow-2xl rounded p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
        <h1 className="font-inter text-primary font-bold text-center text-2xl mb-5 mt-16">Start Your Journey With Us!</h1>
        <h2 className="font-inter text-primary text-center text-xl mb-5">Enter the following details:</h2>
        <Formik
          initialValues={{
            fullName: '',
            email: '',
        ...
        >
          {({ errors, touched }) => (
            <Form className="px-8 pt-6 pb-8 mb-4">
              <div className="mb-4">
                <label className="font-inter block text-primary text-sm font-bold mb-2" htmlFor="fullname">
                  Full Name
                </label>
                <Field
                ...
                {errors.fullName && touched.fullName ? (
                  <p className="font-inter text-red-500 text-xs italic">{errors.fullName}</p>
                ) : null}
              </div>
              <div className="mb-4">
                <label className="font-inter block text-primary text-sm font-bold mb-2" htmlFor="email">
                  Email
                </label>
                <Field
                  className={`font-inter shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
                ...
                {errors.email && touched.email ? (
                  <p className="font-inter text-red-500 text-xs italic">{errors.email}</p>
                ) : null}
              </div>
              <div className="mb-4">
                <label className="font-inter block text-primary text-sm font-bold mb-2" htmlFor="password">
                  Password
                </label>
                <Field
                  className={`font-inter shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
                ...
                {errors.password && touched.password ? (
                  <p className="text-red-500 text-xs italic font-inter">{errors.password}</p>
                ) : null}
              </div>
